...
public class VehDetailRequestEntity {


    /**
     * vehicle_no : MH 01 AB 1045
     * vehicle_id : 2
     * front_front_bumper : Safe
     * front_front_panel : Cracked
     * front_indicator_light_RT : Cracked
     * front_head_lamp_LT : Cracked
     * front_fog_lamp_LT : Cracked
     * front_left_apron : Cracked
     * front_indicator_light_LT : Cracked
     * front_grill : Cracked
     * front_bonnet : Cracked
     * front_head_lamp_RT : Cracked
     * front_fog_lamp_RT : Safe
     * front_right_apron : Cracked
     * rear_rear_bumper : Cracked
     * rear_dickey_door : Dented
     * rear_tail_lamp_RT : Cracked
     * rear_dicky : Cracked
     * rear_tail_lamp_LT : Safe
     * lt_front_door : Cracked
     * lt_qtr_panel : Dented
     * lt_rear_door : Cracked
     * lt_running_board : Cracked
     * lt_pillar_board : Cracked
     * lt_pillar_door_A : Dented
     * lt_pillar_center_B : Cracked
     * lt_pillar_rear_C : Cracked
     * rt_qtr_panel : Cracked
     * rt_floor_silencer : Safe
     * rt_rear_pillar_C : Cracked
     * rt_front_door : Cracked
     * rt_front_fender : Cracked
     * rt_centre_pillar_B : Dented
     * rt_rear_door : Cracked
     * rt_rear_view_mirror_LT : Cracked
     * rt_running_board : Cracked
     * rt_front_pillar_A : Cracked
     * glass_back_glass : Broken
     * glass_rim : Cracked
     * glass_front_windshield : Cracked
     * glass_under_carriage : Cracked
     * glass_rf_door_glass : Cracked
     * glass_top_roof : Cracked
     * glass_dashboard : Cracked
     * glass_engine : Cracked
     * glass_suspension : Broken
     * glass_radiator : Cracked
     * glass_drive_shaft : Cracked
     * glass_brakes : Safe
     * glass_rr_door_glass : Cracked
     * glass_roof_lining : Cracked
     * glass_lt_door_glass : Cracked
     * glass_seats_front : Cracked
     * glass_lr_door_glass : Cracked
     * glass_seats_rear : Cracked
     * glass_instrument_meters : Cracked
     * glass_gear_box : Cracked
     * glass_steering_system : Cracked
     * glass_air_conditioner : Cracked
     * glass_wheels : Cracked
     * glass_music_system : Cracked
     */
    ...
    private String rt_rear_pillar_C;
    ...
    private String glass_back_glass;
    ...
    public String getLt_rear_door() {
        return lt_rear_door;
    }

    public void setLt_rear_door(String lt_rear_door) {
        this.lt_rear_door = lt_rear_door;
    }
    ...
    public String getRt_rear_pillar_C() {
        return rt_rear_pillar_C;
    }

    public void setRt_rear_pillar_C(String rt_rear_pillar_C) {
        this.rt_rear_pillar_C = rt_rear_pillar_C;
    }
    ...
    public String getGlass_back_glass() {
        return glass_back_glass;
    }

    public void setGlass_back_glass(String glass_back_glass) {
        this.glass_back_glass = glass_back_glass;
    }
